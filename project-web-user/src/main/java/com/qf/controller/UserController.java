...
public class UserController {
    ...
    public R login(TUser tuser,
                   ...
                   @CookieValue(value = "user-key", required = false) String UserKey,
                   @CookieValue(value="shopcart-key",required = false)String shopcartkey) {
        //判断有没有值传入
        ...
        Cookie cookie2 = new Cookie("shopcart-key", "");
        cookie2.setPath("/");
        cookie2.setMaxAge(0);
        resp.addCookie(cookie);
        if ("".equals(shopcartkey)||shopcartkey==null){
            shopcartkey="NOexist";
        }
        service.merge(id, shopcartkey);
